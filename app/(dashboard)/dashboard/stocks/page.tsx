...
const STOCKS = [
  ...
  { symbol: "AAOI", name: "Applied Optoelectronics, Inc.", tvSymbol: "NASDAQ:AAOI", price: 8.20 },
  { symbol: "AAON", name: "AAON, Inc.", tvSymbol: "NASDAQ:AAON", price: 72.30 },
  { symbol: "AAPL", name: "Apple, Inc.", tvSymbol: "NASDAQ:AAPL", price: 258.83 },
  { symbol: "ABAT", name: "American Battery Technology", tvSymbol: "NASDAQ:ABAT", price: 3.10 },
  { symbol: "ABCB", name: "Ameris Bancorp", tvSymbol: "NASDAQ:ABCB", price: 41.50 },
  { symbol: "ABCL", name: "AbCellera Biologistics, Inc.", tvSymbol: "NASDAQ:ABCL", price: 5.80 },
  { symbol: "TSLA", name: "Tesla, Inc.", tvSymbol: "NASDAQ:TSLA", price: 182.10 },
  { symbol: "NVDA", name: "Nvidia Corporation", tvSymbol: "NASDAQ:NVDA", price: 820.30 },
  { symbol: "GOOGL", name: "Alphabet Inc.", tvSymbol: "NASDAQ:GOOGL", price: 172.50 },
  { symbol: "MSFT", name: "Microsoft Corporation", tvSymbol: "NASDAQ:MSFT", price: 415.20 },
  { symbol: "AMZN", name: "Amazon.com, Inc.", tvSymbol: "NASDAQ:AMZN", price: 192.80 },
];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px", paddingBottom: "8px" }}>
      ...
      <div style={{ display: "flex", gap: "16px", alignItems: "stretch" }}>
        ...
        {/* Explore Stocks panel — fixed width on desktop, hidden on mobile */}
        <div
          className="hidden lg:flex"
          style={{ ...CARD, width: 220, flexShrink: 0, flexDirection: "column", overflow: "hidden" }}
        >
          <div style={{ padding: "16px 16px 8px" }}>
            <p style={{ ...ss, fontSize: 14, fontWeight: 500, color: "#fff", marginBottom: 8 }}>Explore Stocks</p>
            ...
            {filtered.map((s) => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <div>
                    <p style={{ ...ss, fontSize: 11, fontWeight: 700, color: "#fff", lineHeight: "12px", margin: 0 }}>{s.symbol}</p>
                    <p style={{ ...ss, fontSize: 9, color: "#cdcacc", lineHeight: "11px", maxWidth: 110, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", margin: 0 }}>{s.name}</p>
                  </div>
                </div>
      ...
      {/* Mobile-only Explore Stocks — horizontal scrolling chip row */}
      <div className="lg:hidden" style={{ ...CARD, padding: "12px 16px" }}>
        <p style={{ ...ss, fontSize: 13, fontWeight: 500, color: "#fff", marginBottom: 8 }}>Explore Stocks</p>
          ...
          {filtered.map((s) => (
            <button
              ...
              style={{
                ...
                background: selected.symbol === s.symbol ? "#e9d758" : "rgba(255,255,255,0.06)",
                border: "none",
              }}
            >
              <span style={{ fontSize: 11, fontWeight: 700, color: selected.symbol === s.symbol ? "#0e0e52" : "#fff" }}>{s.symbol}</span>
              <span style={{ fontSize: 9, color: selected.symbol === s.symbol ? "#0e0e52" : "#cdcacc", maxWidth: 80, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.name}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
        ...
        <div style={{ ...CARD, flex: "1 1 280px", padding: "20px" }}>
          <p style={{ ...ss, fontSize: 14, fontWeight: 500, color: "#fff", marginBottom: 16 }}>Stock Holdings</p>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px 0" }}>
            {[
              { label: "Shares", value: `0.00 ${selected.symbol}` },
              { label: "Stock Profit", value: "$0.00" },
        ...
        <div style={{ ...CARD, flex: "1 1 200px", padding: "20px", minWidth: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <span style={{ ...ss, fontSize: 11, fontWeight: 700, color: "#fff" }}>${selected.price.toFixed(2)}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
